...
<!-- 行业投向 -->
<template>
  <div class="business_loan_industry">
    <!-- 内容区 -->
    <div class="content" :style="chartBackground">
        <!-- 图表区域 -->
        <div class="chart">
          <div id="myChart_industry" class="content_chart"></div>
        </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    draw() {
        // 初始化echarts实例
        let myChart = this.$echarts.init(document.getElementById('myChart_industry'))
        // 绘制图表
        // 防止越界，重绘canvas
